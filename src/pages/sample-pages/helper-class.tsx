    ...
    <>
      ...
      <Card>
        ...
        <CardBody>
          ...
          <div className="bd-example bg-light-info p-3 my-3">
            <div className="d-inline-block bg-info p-1 me-1 text-white">
              d-inline-block
            </div>
        ...
        <CardBody>
          ...
          <div className="bd-example p-3 bg-light-info my-3">
            <div style={setheight} className="bg-light">
              <div
                className="h-25 d-inline-block bg-info text-white me-1 p-1"
                style={setheight}
              >
                Height 25%
              </div>
              <div
                className="h-50 d-inline-block bg-info text-white me-1 p-2"
                style={setheight}
              >
                Height 50%
              </div>
              <div
                className="h-75 d-inline-block bg-info text-white me-1 p-2"
                style={setheight}
              >
                Height 75%
              </div>
              <div
                className="h-100 d-inline-block bg-info text-white me-1 p-2"
                style={setheight}
              >
                Height 100%
              </div>
      ...
      <Card>
        <CardBody>
          ...
          <div className="bd-example bg-light-info p-3">
            <span className="me-3 p-1 bg-info text-white align-baseline">
              baseline
            </span>
            <span className="me-3 p-1 bg-info text-white align-top">top</span>
            <span className="me-3 p-1 bg-info text-white align-middle">
              middle
            </span>
            <span className="me-3 p-1 bg-info text-white align-bottom">
              bottom
            </span>
            <span className="me-3 p-1 bg-info text-white align-text-top">
              text-top
            </span>
            <span className="me-3 p-1 bg-info text-white align-text-bottom">
              text-bottom
            </span>
          </div>
        </CardBody>
          ...
          <div>
            ...
            <div className="bd-example">
              <table className="bg-light" style={setheight}>
                <tbody>
                  <tr>
                    <td className="me-3 p-1 bg-info text-white align-baseline">
                      baseline
                    </td>
                    <td className="me-3 p-1 bg-info text-white align-top">
                      top
                    </td>
                    <td className="me-3 p-1 bg-info text-white align-middle">
                      middle
                    </td>
                    <td className="me-3 p-1 bg-info text-white align-bottom">
                      bottom
                    </td>
                    <td className="me-3 p-1 bg-info text-white align-text-top">
                      text-top
                    </td>
                    <td className="me-3 p-1 bg-info text-white align-text-bottom">
                      text-bottom
                    </td>
                  </tr>
                </tbody>
