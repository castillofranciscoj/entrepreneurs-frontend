...
const CryptoOrder = () => {
  ...
  return (
    <DashCard
      ...
      subtitle="Buy and Sell Crypto as you Like"
    >
      <Nav tabs className="mt-4">
        <NavItem>
          <NavLink
            className={
              activeTab === "1" ? "active bg-transparent" : "cursor-pointer"
            }
            onClick={() => {
              toggle("1");
            }}
        ...
        <NavItem>
          <NavLink
            className={
              activeTab === "2" ? "active bg-transparent" : "cursor-pointer"
            }
            onClick={() => {
              toggle("2");
            }}
      ...
      <TabContent activeTab={activeTab} className="p-4 border border-top-0">
        <TabPane tabId="1" className="text-center">
          ...
          <div className="circle-box d-inline-block text-white bg-success my-3 mx-auto">
            Or
          </div>
          <InputGroup>
